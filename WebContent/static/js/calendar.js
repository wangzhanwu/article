...
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:260px;text-align:center;}\
            ...
            .box{margin:0px auto;text-align:center;width:190px;height:18px;font-size:14px;font-weight:bold;color:#666}\
            ...
            .redTr{color:red;text-align:center;font-weight:bold;}\
            .blueTr{color:black;text-align:center;};");
        }
